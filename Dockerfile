...
RUN wget https://bitcoinknots.org/files/29.x/29.4.knots20260508/$(cat /tarball-name)
RUN wget https://bitcoinknots.org/files/29.x/29.4.knots20260508/SHA256SUMS.asc
RUN wget https://bitcoinknots.org/files/29.x/29.4.knots20260508/SHA256SUMS
